...
export default function Home() {
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <section className="sticky top-0 z-20 border-b border-[var(--border)] bg-white/85 backdrop-blur-xl">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20 pt-18 text-center sm:px-8 sm:pb-28 sm:pt-24 lg:px-10 lg:pb-32 lg:pt-28">
        <p className="text-sm font-medium text-[var(--muted)]">A beginner-clear OpenClaw system for women</p>
        ...
        <p className="mx-auto mt-6 max-w-3xl text-xl leading-8 text-[var(--muted)] sm:text-2xl">
        ...
        <p className="mx-auto mt-5 max-w-3xl text-base leading-7 text-[var(--muted)] sm:text-lg">
        ...
        <div className="mt-10 mx-auto max-w-4xl rounded-[2rem] bg-white p-6 text-left shadow-[0_20px_60px_rgba(39,28,22,0.06)] ring-1 ring-[var(--border)] sm:p-8">
          <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              <p className="text-sm font-medium text-[var(--muted)]">Free lead magnet</p>
            ...
            <form className="flex flex-col gap-4 rounded-[1.5rem] bg-[var(--background)] p-5 ring-1 ring-[var(--border)]">
              <input
                type="email"
                placeholder="Enter your email"
                className="rounded-full border border-[var(--border)] bg-white px-5 py-4 text-[var(--foreground)] outline-none placeholder:text-[#8d8d92]"
              />
              <button
                type="submit"
        ...
        <div className="mt-14 overflow-hidden rounded-[2.25rem] bg-[radial-gradient(circle_at_top,#ffffff,#f1ebe3)] px-6 py-10 shadow-[0_40px_120px_rgba(0,0,0,0.10)] sm:px-10 sm:py-14">
      ...
      <section className="bg-white py-20 sm:py-24 lg:py-28">
        <div className="mx-auto max-w-5xl px-6 sm:px-8 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            <p className="text-sm font-medium text-[var(--muted)]">How HerClaw Works</p>
          ...
          <div className="mt-14 grid gap-5 md:grid-cols-3">
            {howItWorks.map((item) => (
              <div key={item.title} className="rounded-[1.75rem] bg-[var(--background)] p-8 ring-1 ring-[var(--border)]">
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-white text-sm font-semibold text-[var(--foreground)] shadow-[0_8px_24px_rgba(0,0,0,0.06)]">
                  {item.step.replace("Step ", "")}
                </div>
                <h3 className="text-2xl font-semibold tracking-[-0.03em]">{item.title}</h3>
                {item.detail ? <p className="mt-4 text-base leading-7 text-[var(--muted)]">{item.detail}</p> : null}
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-white py-20 sm:py-24 lg:py-28">
        <div className="mx-auto max-w-5xl px-6 sm:px-8 lg:px-10">
          <div className="text-center">
            <p className="text-sm font-medium text-[var(--muted)]">Does this sound like you?</p>
            <h2 className="mt-3 text-4xl font-semibold tracking-[-0.04em] sm:text-5xl">
          ...
          <div className="mt-12 grid gap-4">
            {soundsLikeYou.map((item) => (
              <div key={item} className="rounded-[1.75rem] bg-[var(--background)] p-7 ring-1 ring-[var(--border)]">
      ...
      <section className="py-20 sm:py-24 lg:py-28">
        <div className="mx-auto grid max-w-6xl gap-8 px-6 sm:px-8 lg:grid-cols-[0.95fr_1.05fr] lg:px-10">
          <div>
            <p className="text-sm font-medium text-[var(--muted)]">The transformation</p>
            <h2 className="mt-3 text-4xl font-semibold tracking-[-0.04em] sm:text-5xl">
      ...
      <section className="bg-white py-20 sm:py-24 lg:py-28">
        <div className="mx-auto max-w-5xl px-6 sm:px-8 lg:px-10">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              <p className="text-sm font-medium text-[var(--muted)]">Why I built HerClaw</p>
              <div className="mt-6 flex aspect-[4/5] max-w-[280px] items-center justify-center rounded-[2rem] bg-[var(--background)] text-sm text-[var(--muted)] ring-1 ring-[var(--border)]">
      ...
      <section className="py-20 sm:py-24 lg:py-28">
        <div className="mx-auto max-w-5xl px-6 sm:px-8 lg:px-10">
          <div className="text-center">
            <p className="text-sm font-medium text-[var(--muted)]">Founder’s Note</p>
            <h2 className="mt-3 text-4xl font-semibold tracking-[-0.04em] sm:text-5xl">
              HerClaw is new, and this first version is for founding customers.
            </h2>
            <p className="mx-auto mt-6 max-w-3xl text-xl leading-8 text-[var(--muted)]">
      ...
      <section className="bg-white py-20 sm:py-24 lg:py-28">
        <div className="mx-auto max-w-5xl px-6 sm:px-8 lg:px-10">
          <div className="text-center">
            <p className="text-sm font-medium text-[var(--muted)]">What’s inside the Starter Kit</p>
            <h2 className="mt-3 text-4xl font-semibold tracking-[-0.04em] sm:text-5xl">
          ...
          <div className="mt-14 grid gap-5">
            {whatsInside.map((item) => (
              <div key={item.title} className="rounded-[1.75rem] bg-[var(--background)] p-7 ring-1 ring-[var(--border)]">
                <h3 className="text-2xl font-semibold tracking-[-0.03em] text-[var(--foreground)]">{item.title}</h3>
                <p className="mt-3 text-lg leading-8 text-[var(--muted)]">{item.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 sm:py-24 lg:py-28">
        <div className="mx-auto max-w-5xl px-6 sm:px-8 lg:px-10">
          <div className="text-center">
            <p className="text-sm font-medium text-[var(--muted)]">What you’ll walk away with</p>
            <h2 className="mt-3 text-4xl font-semibold tracking-[-0.04em] sm:text-5xl">
      ...
      <section className="py-20 sm:py-24 lg:py-28">
        <div className="mx-auto max-w-5xl px-6 sm:px-8 lg:px-10">
          <div className="text-center">
            <p className="text-sm font-medium text-[var(--muted)]">Objection handling</p>
            <h2 className="mt-3 text-4xl font-semibold tracking-[-0.04em] sm:text-5xl">
          ...
          <div className="mt-14 grid gap-5">
            {objections.map((item) => (
              <div key={item.q} className="rounded-[1.75rem] bg-white p-8 shadow-[0_16px_50px_rgba(39,28,22,0.06)] ring-1 ring-[var(--border)]">
                ...
                <p className="mt-4 text-lg leading-8 text-[var(--muted)]">{item.a}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="buy" className="mx-auto max-w-5xl px-6 py-20 text-center sm:px-8 lg:px-10 lg:py-28">
        <p className="text-sm font-medium text-[var(--muted)]">Start building your AI advantage today</p>
        <h2 className="mt-3 text-4xl font-semibold tracking-[-0.04em] sm:text-5xl">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="rounded-[1.75rem] bg-[var(--background)] p-6 ring-1 ring-[var(--border)]">
            <div className="aspect-[16/10] rounded-[1.25rem] bg-white text-left shadow-[0_12px_40px_rgba(0,0,0,0.05)] ring-1 ring-[var(--border)]">
          ...
          <div className="space-y-4">
            <div className="rounded-[1.5rem] bg-[var(--background)] p-5 ring-1 ring-[var(--border)] text-left text-sm text-[var(--muted)]">
